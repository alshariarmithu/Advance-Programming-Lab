...
class FourStarHotel extends Hotel {

    public FourStarHotel(String hotelId, String location, String roomType, int costPerRoom, int totalRoom, int availableRoom) {
        super(hotelId, location, "4-star", roomType, costPerRoom, totalRoom, availableRoom);
    }
    @Override
